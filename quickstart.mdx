  ...
  <Tab title="Docker (Recommended)">
    ...
    <Steps>
      <Step title="Clone the repository">
        ```bash
        git clone https://github.com/timur-me/VBB-Project.git
        cd VBB-Project
        ```
      </Step>
      ...
      <Step title="Configure the bot">
        ...
        ```toml
        [bot]
        token = "7167777777:AaBbCcDdEeFfGgHh"  # Replace with your actual bot token
...
<Card title="View source code" icon="github" href="https://github.com/timur-me/VBB-Project">
